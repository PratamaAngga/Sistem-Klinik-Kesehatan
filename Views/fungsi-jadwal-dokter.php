<div class="page-inner">
  <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
    <div>
      <h3 class="fw-bold mb-1">Function Table: Jadwal Dokter per Tanggal</h3>
      <p class="mb-0">
        Menampilkan hasil function <code>get_jadwal_dokter_by_tanggal('<?= htmlspecialchars($tanggal); ?>')</code>
      </p>
    </div>
  </div>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form method="GET" action="index.php" class="row g-3 mb-4">
            <input type="hidden" name="page" value="fungsi-jadwal-dokter">
            <div class="col-auto">
